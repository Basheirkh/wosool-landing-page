...
export default function StatsFullBleed() {
  const stats = [
    { end: 4, suffix: "", label: "موظفين ذكاء اصطناعي", sublabel: "لكل متجر" },
    { end: 24, suffix: "/7", label: "تشغيل متواصل", sublabel: "بدون ساعات عمل" },
    { end: 2, suffix: "", label: "دقائق للربط", sublabel: "لبداية التشغيل" },
    { end: 1, suffix: "", label: "واتساب واحد", sublabel: "لإدارة اليوم" },
  ];

  return (
    <section className="relative py-0">
      <div className="relative px-6 py-24 bg-background">
        <div className="max-w-[1400px] mx-auto">
          ...
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-right py-16 md:py-24 md:pr-8 last:border-r-0"
              style={{ borderRight: index === stats.length - 1 ? "0" : "1px solid var(--art-border)" }}
            >
