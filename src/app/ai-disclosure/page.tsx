              ...
              <div>
                <div className="theme-article-surface rounded-[32px] p-8 md:p-12">
                  <LegalHeader
                    ...
                    intro="تلتزم منصة وصول بمبادئ الهيئة السعودية للبيانات والذكاء الاصطناعي (SDAIA) للذكاء الاصطناعي الأخلاقي. هذه الصفحة تُفصح بوضوح كيف يعمل وصول، ما يستطيع وما لا يستطيع، وكيف تحتفظ بالسيطرة الكاملة على القرارات التي تؤثر على متجرك وعملائك."
                  />
                  ...
                  <div className="mt-14 space-y-14 leading-9">
                    ...
                    >
                      <p>
                        داخل فريق وصول، نُطبّق حوكمة صارمة لتطوير ونشر أنظمة
                        الذكاء الاصطناعي:
                      </p>
                      <ul className="mt-4 space-y-2">
                        <li>
